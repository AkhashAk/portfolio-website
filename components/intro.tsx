...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        Hello, I'm <span className="font-bold">Akhash Kailaianhiri.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">4+ years</span> of experience.<br />
        I enjoy building <span className="italic">full-stack web applications</span> and creating seamless user experiences that make a difference.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="/Akhash_Kailaianhiri_Resume.pdf"
          download
        >
          Get my Resume{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/akhash-kailaianhiri/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/AkhashAk"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
